...
const AddServiceForm = ({ handleSubmit, arrivalDate, setArrivalDate, setDepartureDate, departureDate , loading}) => {
  return (
    <>
      <div className='flex justify-center mt-6'>
        <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
          <form onSubmit={handleSubmit} className='space-y-6 ng-untouched ng-pristine ng-valid'>
              ...
              <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(data) => setDepartureDate(data)} className='w-2/3'
                  />
                </div>
            ...
            >
              {
                loading ? <SmallSpinner></SmallSpinner>  : "Save & Continue"
              }
